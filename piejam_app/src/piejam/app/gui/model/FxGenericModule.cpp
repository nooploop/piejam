...
struct FxGenericModule::Impl
{
    ...
    piejam::gui::model::FxParametersList parameters;
};
...
auto
FxGenericModule::parameters() noexcept -> piejam::gui::model::FxParametersList*
{
    return &m_impl->parameters;
}

auto
FxGenericModule::parameters() const noexcept
