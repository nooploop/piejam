...
struct event_to_audio_smoother_processor_test : testing::Test
{
    event_to_audio_smoother_processor_test()
    {
...
{
    auto sut = make_event_to_audio_smoother_processor();
...
TEST_F(event_to_audio_smoother_processor_test, default_will_produce_silence)
{
    auto sut = make_event_to_audio_smoother_processor();
    sut->process(ctx);
...
TEST_F(event_to_audio_smoother_processor_test, event_at_begin_of_buffer)
{
    auto sut = make_event_to_audio_smoother_processor();
...
TEST_F(event_to_audio_smoother_processor_test, rampup_inside_buffer)
{
    auto sut = make_event_to_audio_smoother_processor();
...
TEST_F(event_to_audio_smoother_processor_test, noramp_if_same_target)
{
    auto sut = make_event_to_audio_smoother_processor();
...
TEST_F(event_to_audio_smoother_processor_test, ramp_over_process_boundary)
{
    auto sut = make_event_to_audio_smoother_processor();
